...
import checkIsMultisig from "../../helpers/Multisig";
            ...
            <Navbar />
            {
                ...
                "/>
                    ...
                    <div className="flex flex-row justify-between">
                        <div className="ml-24 mt-16">
                            <div className="mb-8 text-6xl font-roboto font-bold">
                                Address does not belong to multisig wallet <br />

                                <Link className="font-medium font-roboto text-4xl text-black hover:underline" href="/wallet">Create one here</Link>
                            </div>
                        </div>
                    </div>
            }
